...
- desenvolvimento de software e arquitetura escalável
- privacidade de dados e conformidade LGPD
- automação de processos (RPA, Power Platform, AI Agents)
- cibersegurança aplicada a produtos e fluxos web
...
SaaS de gestão financeira pessoal e PJ com agente de IA autônomo, interface web e integração com WhatsApp Business.

- registro de transações por voz, texto, imagem e PDF
- análises de gastos, detecção de anomalias e projeção de contas a pagar
- controle de múltiplas contas, empréstimos, cartões e recorrências
- planos Free / Pro / Genius com gating granular de recursos
- compliance LGPD com transparência de cookies, exclusão de conta e logs estruturados

### EMF Tech

Empresa brasileira de tecnologia com entrega sob medida para operações digitais.

- desenvolvimento de software, sites e aplicações web
- automação de processos (workflow / RPA)
- integração de APIs e sistemas externos
- segurança de dados e soluções alinhadas à LGPD

### Cibersegurança aplicada

- estudo e prática de pentest com foco em reconhecimento de aplicações web
